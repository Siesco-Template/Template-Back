...
namespace Auth.DAL.Migrations
{
    ...
    [Migration("20250811141018_folder_tables")]
    partial class folder_tables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Auth.Core.Entities.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Auth.Core.Entities.Sale", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Auth.Core.Entities.Sale", b =>
                {
                    b.HasOne("Auth.Core.Entities.Department", "Department")
                        .WithMany("Sales")
